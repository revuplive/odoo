...
class ProductData(WebsiteSale):
    ...
    @http.route([
        '''/collections/<model("product.public.category"):category>''',
        '''/collections/<model("product.public.category"):category>/page/<int:page>''',
        '''/collections/<model("product.public.category"):category>/product/<model("product.template"):product>'''
        ], auth='public', type='http', website=True)
    def collection_item(self, page=0, category=None, search='', min_price=0.0, max_price=0.0, ppg=False, **post):
    ...
    @http.route([
    '''/collections/<model("product.public.category"):category>/products/<model("product.template"):product>''',
    '''/featured-products/products/<model("product.template"):product>''',
    ] , auth='public', type='http', website=True)
